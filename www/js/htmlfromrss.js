      ...
      $.ajax(feed, {
        ...
        success:function(data) {
          ...
          $($xml).find("item").each(function () { 
            ...
            $('.htmlfromrss ul#htmlfromrss' + i).append('<div class="card demo-facebook-card"><div class="card-header"><div class="demo-facebook-avatar"><img src="img/logo50bulat.png" width="34" height="34"/></div><div class="demo-facebook-name">'+j+'</div><div class="demo-facebook-date">'+date_indo(standard_time($pubDate).toUTCString())+'</div></div><div class="card-content card-content-padding"><a href="'+$link+'" class="openBrowser">'+$title+img+'</a></div><div class="card-footer">'+relative_time($pubDate)+'<a href="'+$link+'" class="openPreview"><button class="col button button-fill color-red">Baca</button></a></div></div>');            
